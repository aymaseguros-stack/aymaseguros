#!/usr/bin/env python3
"""
Script para agregar Cookie Banner a AYMA Landing
Ejecutar desde carpeta aymaseguros-landing:
    python3 add_cookie_banner.py
"""
...
# ============================================================================
COOKIE_BANNER_JSX = '''import { useState, useEffect } from 'react';
...
def main():
    ...
    cookie_path = 'src/components/CookieBanner.jsx'
    with open(cookie_path, 'w', encoding='utf-8') as f:
        f.write(COOKIE_BANNER_JSX)
    print(f"✅ Creado: {cookie_path}")
    
    # Actualizar App.jsx
    app_path = 'src/App.jsx'
    with open(app_path, 'w', encoding='utf-8') as f:
        f.write(APP_JSX)
    print(f"✅ Actualizado: {app_path}")
    
    print("")
    print("CARACTERÍSTICAS DEL COOKIE BANNER:")
    print("  • Cumple Ley 25.326 (Argentina) + GDPR")
    print("  • Google Consent Mode v2 integrado")
    print("  • Meta Pixel consent")
    print("  • 3 opciones: Aceptar todas / Solo esenciales / Ver detalles")
    print("  • Guarda preferencia en localStorage")
    print("  • Diseño profesional con overlay")
    print("  • Link a Política de Privacidad")
    print("")
    print("PRÓXIMOS PASOS:")
    print("  npm run build")
    print("  git add -A")
    print("  git commit -m 'Add: Cookie banner con Consent Mode v2'")
    print("  git push")
