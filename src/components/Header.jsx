      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <button onClick={handlePortal} className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-semibold transition-all hover:scale-105 shadow-md ${isScrolled ? 'bg-ayma-blue hover:bg-ayma-blue-dark text-white' : 'bg-white hover:bg-gray-100 text-ayma-blue'}`}>
